...
Message _messageDeserialize(
  ...
  final object = Message(
    ...
    error: reader.readStringOrNull(offsets[4]),
    id: id,
    metadata: reader.readStringOrNull(offsets[5]),
    role: _MessageroleValueEnumMap[reader.readByteOrNull(offsets[6])] ??
        MessageRole.user,
    status: _MessagestatusValueEnumMap[reader.readByteOrNull(offsets[7])] ??
        MessageStatus.sending,
    tokenCount: reader.readLongOrNull(offsets[8]),
...
extension MessageQueryWhereSort on QueryBuilder<Message, Message, QWhere> {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anyRole() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension MessageQueryWhere on QueryBuilder<Message, Message, QWhereClause> {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> agentIdEqualTo(
      String agentId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'agentId',
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> agentIdNotEqualTo(
      String agentId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> roleEqualTo(
      MessageRole role) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'role',
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> roleNotEqualTo(
      MessageRole role) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> roleGreaterThan(
    MessageRole role, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> roleLessThan(
    MessageRole role, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> roleBetween(
    MessageRole lowerRole,
    MessageRole upperRole, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdEqualTo(
    String value, {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'agentId',
        value: '',
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> agentIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'agentId',
        value: '',
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> tokenCountIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> tokenCountIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'tokenCount',
      ));
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  QueryBuilder<Message, Message, QAfterSortBy> sortByAgentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'agentId', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByAgentIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQuerySortThenBy
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByAgentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'agentId', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByAgentIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'agentId', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByAgentId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, String, QQueryOperations> agentIdProperty() {
    return QueryBuilder.apply(this, (query) {
